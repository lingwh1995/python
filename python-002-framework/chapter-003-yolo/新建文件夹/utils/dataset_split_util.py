...
if __name__ == '__main__':
    dataset_dir = 'E:/images/'
    dataset_name = 'dial'
    image_path = os.path.join(dataset_dir, 'dataset', dataset_name, 'images')  # 图片文件夹
    annotation_path = os.path.join(dataset_dir, 'dataset', dataset_name, 'labels')  # 标签文件夹
    dataset_split_path = os.path.join(dataset_dir, 'dataset', dataset_name, 'split')  # 新数据存放位置
